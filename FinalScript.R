...
#Setting Working Directory
  setwd("C:/Raghav/Coding/R/UCIResearch/Pathogenic_Activity_Project")

#Importing Dataset
  imp.data = Read10X(data.dir = "C:/Raghav/Coding/R/UCIResearch/Pathogenic_Activity_Project/data/filtered_feature_bc_matrix-20210630T115618Z-001/filtered_feature_bc_matrix")
  imp.data
...
#Reducing the number of mCherry counted
  ...
  #Plot mCherry expression
    DimPlot(matr, reduction = "umap", group.by = "mCherry_2", label = TRUE, pt.size = 0.5) + NoLegend()
    FeaturePlot(matr, features = "mCherry", label = TRUE, pt.size = 0.5) + NoLegend()
    DimPlot(matr, reduction = "umap", group.by = "mCherry_2", label = TRUE, pt.size = 0.5) + NoLegend()
...
#Isolating mCherry cells that exhibit pathogenic misexpression
  ...
  FeaturePlot(matr, features = "pathogenicmCherry", label = TRUE, pt.size = 0.5) + NoLegend()
  ...
  #Find pathogenicmCherry_markers
    ...
    FeaturePlot(matr, features = "nonexpressedcells", label = TRUE, pt.size = 0.5) + NoLegend()
